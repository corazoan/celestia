...
export default function ProductClientPage({ product }: ProductClientPageProps) {
  ...
  return (
    <div className="bg-white dark:bg-zinc-950 min-h-screen pt-20 pb-12">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
          {/* Left Side: Image Gallery & Details */}
          <div className="md:w-1/2 space-y-8">
            <div className="space-y-4">
              <div className="relative aspect-square bg-white dark:bg-zinc-900 rounded-xl border border-gray-100 dark:border-zinc-800 overflow-hidden flex items-center justify-center p-4">
                <CldImage
                  src={activeImage}
                  width={600}
                  height={600}
                ...
                />
                {discount > 0 && (
                  <div className="absolute top-3 left-3 bg-blue-600 text-white text-[10px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider">
                    {discount}% OFF
                  </div>
                )}
              </div>
              ...
              <div className="flex gap-2 overflow-x-auto scrollbar-hide py-1 justify-center">
                {allImages.map((img, idx) => (
                  <button
                    ...
                    className={`relative size-14 min-w-14 rounded-lg border-2 overflow-hidden transition-all ${
                      activeImage === img
                        ? "border-green-600"
            ...
            {/* Product Details Section - Now on the left */}
            <div className="pt-8 border-t border-gray-100 dark:border-zinc-800">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <div className="border-b border-gray-100 dark:border-zinc-800 pb-2">
                  ...
                  <div className="text-xs text-gray-900 dark:text-zinc-100 font-medium">
                    {product.unit.abbr}
                  </div>
                </div>
                <div className="border-b border-gray-100 dark:border-zinc-800 pb-2">
          ...
          {/* Vertical Separator */}
          <div className="hidden md:block w-px bg-gray-100 dark:bg-zinc-800 self-stretch" />

          {/* Right Side: Product Info */}
          <div className="md:w-1/2 flex flex-col">
            {/* Breadcrumbs */}
            <nav className="flex items-center text-[11px] text-gray-500 dark:text-zinc-400 mb-2">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-1">
              {product.name}
            </h1>
            ...
            {/* Variant Selector */}
            <div className="mb-6">
              <h3 className="text-[11px] font-bold text-gray-900 dark:text-zinc-100 mb-3 uppercase tracking-wider">
                Select Unit
              </h3>
              <div className="flex flex-wrap gap-2">
                {product.ProductVariant.map((variant) => (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center px-4 py-2 rounded-lg border transition-all ${
            ...
            <div className="mt-4 border-t border-gray-100 dark:border-zinc-800 pt-6">
              ...
              {/* Trust Section */}
              <div className="space-y-4">
                <h4 className="text-[11px] font-bold text-gray-900 dark:text-zinc-100 uppercase tracking-wider">
                  Why shop from Celestia?
                </h4>
                <div className="grid gap-3">
                  <div className="flex items-center gap-3">
                    <div className="size-7 rounded-full bg-green-50 dark:bg-green-900/20 flex items-center justify-center shrink-0">
                      <svg
