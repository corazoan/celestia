    ...
    <div className="bg-white dark:bg-zinc-950 min-h-screen pt-24 pb-12">
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-auto border-t border-gray-100 dark:border-zinc-800 pt-6">
              <div className="flex items-end gap-3 mb-6">
                <div>
                  <div className="text-sm text-gray-500 dark:text-zinc-400 mb-1">Price</div>
              ...
              <div className="bg-gray-50 dark:bg-zinc-900/50 rounded-2xl p-5 space-y-4 border border-gray-100 dark:border-zinc-800">
                <h4 className="text-sm font-bold text-gray-900 dark:text-zinc-100 mb-1">Why shop from Celestia?</h4>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-[13px] font-bold text-gray-900 dark:text-zinc-100">Superfast Delivery</div>
                    <div className="text-xs text-gray-500 dark:text-zinc-400">Get your order delivered in minutes.</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="size-8 bg-white dark:bg-zinc-800 rounded-full flex items-center justify-center border border-gray-100 dark:border-zinc-700 shrink-0">
                  ...
                  <div>
                    <div className="text-[13px] font-bold text-gray-900 dark:text-zinc-100">Best Prices & Offers</div>
                    <div className="text-xs text-gray-500 dark:text-zinc-400">Direct from manufacturers to your doorstep.</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-16 md:mt-24 border-t border-gray-100 dark:border-zinc-800 pt-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-8">Product Details</h2>
          <div className="max-w-3xl">
            <div className="prose prose-sm dark:prose-invert max-w-none text-gray-600 dark:text-zinc-400">
              {selectedVariant.description ? (
                ...
                <p>No detailed description available for this product variant.</p>
              )}
            </div>
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="border-b border-gray-100 dark:border-zinc-800 pb-3">
                <div className="text-[11px] text-gray-400 uppercase font-bold tracking-wider mb-1">Unit</div>
                <div className="text-sm text-gray-900 dark:text-zinc-100 font-medium">{product.unit.abbr}</div>
              </div>
              <div className="border-b border-gray-100 dark:border-zinc-800 pb-3">
                <div className="text-[11px] text-gray-400 uppercase font-bold tracking-wider mb-1">Net Quantity</div>
                <div className="text-sm text-gray-900 dark:text-zinc-100 font-medium">{selectedVariant.unitValue} {product.unit.abbr}</div>
              </div>
            </div>
          </div>
        </div>
